...
<html>
<head>
<title>Launch Page: Fernie Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="fernieForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Fernie, Level 1</option>
				<option value="02">Fernie, Level 2</option>
				<option value="03">Fernie, Level 3</option>
				<option value="04">Fernie, Level 4</option>
				<option value="05">Fernie, Level 5</option>
				<option value="06">Fernie, Level 6</option>
				<option value="07">Fernie, Level 7</option>
				<option value="08">Fernie, Level 8</option>
				<option value="09">Fernie, Level 9</option>
				<option value="10">Fernie, Level 10</option>
			  </select>
        ...
        {
            $("#fernieForm").attr('action', "fernie/fernie"+ $("#level").val() +  ".php");
        });
